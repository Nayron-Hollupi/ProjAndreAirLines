...
using ProjAndreAirLines.Server;
...
namespace ProjAndreAirLines.Controllers
{
    ...
    public class PassageiroesController : ControllerBase
    {
        ...
        public PassageiroesController(ProjAndreAirLinesContext context)
        {
            _context = context;
        }
        ...
        {
            var endereco = await ApiCorreio.CorreioApi(passageiro.Endereco.CEP);
